                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-4">
                                    <Link href="/products/" className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</Link>
                            ...
                            <div className="relative ml-3">
                                <div>
                                    <button type="button" className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        ...
                                        <img className="h-8 w-8 rounded-full" src="https://media.licdn.com/dms/image/D4E03AQH1RdEYaetq2Q/profile-displayphoto-shrink_200_200/0/1695174202384?e=2147483647&v=beta&t=FUSJzZAQ_Ynem8C8kMvZyYiTNPsHntbiZtwwQku6uTM" alt="" />
                                    </button>
                                </div>
                            </div>
                        </div>
